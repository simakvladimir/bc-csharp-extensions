...
{
    public abstract class Gost34310KeyParameters
        : AsymmetricKeyParameter
    {
            ...
            DerObjectIdentifier publicKeyParamSet)
        {
            ...
            Gost3410ParamSetParameters p = Gost34310NamedParameters.GetByOid(publicKeyParamSet);

            if (p == null)
                throw new ArgumentException("OID is not a valid KNCA public key parameter set", "publicKeyParamSet");
